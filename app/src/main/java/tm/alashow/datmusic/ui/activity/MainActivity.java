...
public class MainActivity extends BaseActivity implements EndlessRecyclerView.Pager, OnItemClickListener {
    ...
    @BindView(R.id.recyclerView) EndlessRecyclerView recyclerView;
    @BindView(R.id.fastScroller) RecyclerFastScroller fastScroller;
    @BindView(R.id.progress) ProgressWheel progressView;
    ...
    private void registerGCM() {
        try {
            ...
            Log.i("REGID:",""+regId);
            Log.i("DEVICE",""+U.getDeviceId(this));
            if (regId.equals("")) {
                GCMRegistrar.register(this, Config.GCM_SENDER_ID);
            } else {
                if (Remember.getBoolean("gcmSent", false)) {
                    Log.e("REGID:",""+regId);
                    Log.e("DEVICE",""+U.getDeviceId(this));
